...
export const encodeErc20Transfer = (to: string, value: BigNumber): string => {
    return ERC20_INTERFACE.encodeFunctionData("transfer(address,uint256)", [
        to,
        value,
    ]);
};

export const encodeErc1155TransferFrom = (
    from: string,
    to: string,
    id: string,
    value: BigNumber,
...
export const encodeErc20Approve = (
    ...
    return ERC20_INTERFACE.encodeFunctionData("approve(address,uint256)", [
        spender,
        approvalAmount,
    ]);
};
